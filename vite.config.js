...
const SEO={
  "dang-ky-hoc-lai-xe.html":{title:"Học lái xe cùng Đạt",description:"Đăng ký học lái xe A1, A, B số tự động, B số sàn và C1 cùng Đạt. Học phí rõ ràng, học 600 câu online và theo dõi tiến độ tập trung.",path:"/",image:BRAND_HERO},
...
function cleanBrandWording(html){return html.replace(PACKAGE_WORDING,"").replace(UNVERIFIED_CENTER,"Học lái xe cùng Đạt").replace(LEGACY_HOSTS,ORIGIN).replace(LEGACY_HERO,BRAND_HERO).replace(/>\s*[·|•–—-]+\s*</g,"><").replace(/\s+[·|•–—-]+\s+(?=<)/g," ")}
