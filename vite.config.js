...
function stabilizeStudentPortal(html){
  for(const script of ["site-enhancements.js","pwa-install.js","push-notifications.js","mobile-dashboard.js"]){
    html=html.replace(new RegExp(`\\s*<script\\s+type=\\"module\\"\\s+src=\\"/${script.replace(".","\\.")}(?:\\?[^\\"]*)?\\"\\s*><\\/script>`,`g`),"");
  }
  html=html.replace('</body>','  <script type="module" src="/student-postboot.js?v=20260818-1"></script>\n</body>');
  return html;
}
