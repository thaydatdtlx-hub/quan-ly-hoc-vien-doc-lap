...
function installLoginBootstrap(html){
  const appScript='<script type="module" src="/app.js?v=2"></script>';
  if(!html.includes(appScript)||html.includes('/student-login-bootstrap.js'))return html;
  return html.replace(appScript,`<script type="module" src="/student-login-bootstrap.js?v=20260813-1"></script>\n  ${appScript}`);
}
