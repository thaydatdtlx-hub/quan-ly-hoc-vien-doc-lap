...
const SEO={
  ...
  "chinh-sach-bao-mat.html":{title:"Chính sách bảo mật | Học lái xe cùng Đạt",description:"Chính sách thu thập, sử dụng, bảo vệ và xử lý dữ liệu cá nhân trên hệ thống Học lái xe cùng Đạt.",path:"/chinh-sach-bao-mat.html",image:"/hero-vip-navy-champagne.webp?v=1"}
};
...
function isolateStudentPortal(html){
  ...
  html=html.replace('</body>',`  ${cleanup}\n  <script type="module" src="/student-rescue-runtime.js?v=20260813-5"></script>\n  <script type="module" src="/student-attendance-rescue.js?v=20260813-1"></script>\n  <script type="module" src="/student-payment-history-rescue.js?v=20260813-1"></script>\n</body>`);
  return html;
}
