...
if(tuitionAnchor&&!document.getElementById("hoc-phi-tu-van")){
  ...
  section.innerHTML=`<div class="tuition-shell">
    ...
    <div class="tuition-alert"><b>!</b><span><strong>Lưu ý:</strong> A1 và A có lệ phí sát hạch, cấp PET nộp riêng tại sân thi. Với hạng B, lệ phí khám sức khỏe, sát hạch, cấp giấy phép và tập xe cảm biến không nằm trong mức học phí 22.000.000 VNĐ, trừ khi có xác nhận khác bằng văn bản.</span></div>
    <div class="tuition-grid">${plans.map(card).join("")}</div>
    <div class="tuition-package">
      <div class="tuition-package__head"><div><p>GÓI HỌC PHÍ HẠNG B</p><h3>Các nội dung thuộc chương trình đào tạo</h3></div><span>Hạng B hiện hành không còn phân loại B1 và B2 theo mục đích kinh doanh vận tải. Website dùng tên “B số tự động” và “B số sàn” để học viên dễ lựa chọn loại xe đào tạo.</span></div>
