...
for(const token of ["refresh-topline","refresh-hero-panel","refresh-proof","refresh-audience","refresh-form-steps","refresh-mobile-cta","@media(max-width:780px)"]){
...
for(const token of ['thay-dat-pwa-v7','"/bo-tuc-tay-lai.html"'])if(!worker.includes(token))throw new Error(`PWA thiếu: ${token}`);
