...
if(!page.includes("/driving-refresh-v2.css?v=8"))throw new Error("Trang bổ túc chưa nạp đúng phiên bản giao diện V2 mới nhất.");
...
for(const token of ['thay-dat-pwa-v17','"/bo-tuc-tay-lai.html"'])if(!worker.includes(token))throw new Error(`PWA thiếu: ${token}`);
