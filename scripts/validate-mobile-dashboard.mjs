...
const [admin,student,css,mobileLock,enhancements,client,studentClient,refreshClient,worker]=await Promise.all([
...
for(const token of ["mobile-viewport-lock.css?v=1","ensureMobileViewportStyles"]){
