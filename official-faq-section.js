...
if(faqSection){
  const items=[
    ["CẬP NHẬT 01/07/2026","Thi sát hạch hạng B, C1 hiện còn phần thi mô phỏng không?","Không. Từ ngày 01/07/2026, sát hạch lái xe ô tô hạng B và C1 không còn bài thi mô phỏng các tình huống giao thông trên máy tính. Người dự thi thực hiện tuần tự ba nội dung: lý thuyết, thực hành lái xe trong hình và thực hành lái xe trên đường; phải đạt nội dung trước mới được thi nội dung tiếp theo."],
    ...
    ["THỜI GIAN","Khóa B và C1 học trong bao lâu?","Thời gian dự kiến của B số tự động và B số sàn là 2,5–3 tháng; C1 là 3,5–4 tháng. Lịch thực tế phụ thuộc kế hoạch khai giảng, tiến độ hoàn thành nội dung bắt buộc và lịch sát hạch."],
    ...
    ["DAT · CABIN","DAT và cabin có ý nghĩa gì?","DAT là nội dung thực hành có ghi nhận dữ liệu quãng đường và thời gian học. Cabin điện tử là nội dung đào tạo đối với hạng áp dụng; cabin đào tạo không phải là bài thi mô phỏng. Từ ngày 01/07/2026, sát hạch B và C1 không còn phần thi mô phỏng trên máy tính."],
  ...
  faqSection.innerHTML=`
    ...
    <div class="official-faq-source"><span class="official-faq-source__mark">⚖️</span><div><strong>Cập nhật sát hạch ô tô từ ngày 01/07/2026</strong><small>Hạng B và C1 thi lý thuyết, thực hành trong hình và thực hành trên đường; không còn bài thi mô phỏng trên máy tính.</small></div><div class="official-faq-source__links"><a href="https://congbao.chinhphu.vn/van-ban/thong-tu-so-108-2026-tt-bca-470055.htm" target="_blank" rel="noopener noreferrer">Thông tư 108/2026/TT-BCA</a><a href="#hoc-phi-tu-van">Xem bảng học phí</a></div></div>
