...
function mountEligibility(){
  ...
  if(!anchor)return;
  const data=[
    {badge:"A1",title:"Hạng A1",vehicle:"Xe mô tô hai bánh có dung tích xi-lanh đến 125 cm³ hoặc công suất động cơ điện đến 11 kW.",age:"Từ đủ 18 tuổi.",term:"Không thời hạn.",exam:"Lý thuyết và thực hành lái xe trong hình."},
    {badge:"A",title:"Hạng A",vehicle:"Xe mô tô hai bánh trên 125 cm³ hoặc công suất động cơ điện trên 11 kW; đồng thời được điều khiển xe thuộc hạng A1.",age:"Từ đủ 18 tuổi.",term:"Không thời hạn.",exam:"Lý thuyết và thực hành lái xe trong hình."},
