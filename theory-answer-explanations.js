...
function explanationText(question){
  ...
  if(!answer)return"Hãy ghi nhớ đáp án đúng và đối chiếu lại nội dung câu hỏi trước khi chuyển sang câu tiếp theo.";
  return `Ghi nhớ: ${answer.text} Đây là đáp án đúng theo bộ 600 câu hỏi đang áp dụng trên hệ thống.`;
}
  ...
  feedback.innerHTML=`
    ...
    <div class="answer-result-copy">
      ...
      <div class="answer-explanation-box">
        ...
        <p>${esc(explanationText(question))}</p>
