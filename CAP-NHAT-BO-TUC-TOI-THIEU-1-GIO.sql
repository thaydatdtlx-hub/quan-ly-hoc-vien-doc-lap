-- CHO PHÉP ĐĂNG KÝ BỔ TÚC TỐI THIỂU 1 GIỜ
...
alter table public.driving_refresh_registrations
  ...
  check (duration_hours between 1 and 20);
...
begin
  ...
  if v_duration_hours is null or v_duration_hours < 1 or v_duration_hours > 20 then
    raise exception 'Số giờ đăng ký phải từ 1 đến 20 giờ.';
  end if;
